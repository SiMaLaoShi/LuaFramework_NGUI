...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("GUICAMERA", get_GUICAMERA, set_GUICAMERA);
		L.RegVar("GUIROOT", get_GUIROOT, set_GUIROOT);
	...
	static int get_GUICAMERA(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.GUICAMERA);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_GUIROOT(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.GUIROOT);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_GUICAMERA(IntPtr L)
	{
		try
		{
			string arg0 = ToLua.CheckString(L, 2);
			LuaFramework.AppConst.GUICAMERA = arg0;
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_GUIROOT(IntPtr L)
	{
		try
		{
			string arg0 = ToLua.CheckString(L, 2);
			LuaFramework.AppConst.GUIROOT = arg0;
			return 0;
		}
		catch (Exception e)
		{
